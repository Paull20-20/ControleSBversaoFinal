...
class Task(models.Model):
    ...
    orçamento01 = models.FileField(upload_to='anexos/', null=True) #onde o upload irá ficar tem que ser definido no Media_Root (settigns.py do projeto todo) (quando o site tiver no servidor deve se especificar uma outra pasta)
    orçamento02 = models.FileField(upload_to='anexos/', null=True) 
    orçamento03 = models.FileField(upload_to='anexos/', null=True)
